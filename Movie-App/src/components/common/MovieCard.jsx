...
const MovieCard = () => {
  return (
    <div class="overflow-hidden cursor-pointer relative h-80 w-54 rounded-md group">
      {/* ảnh nền */}
      ...
      <div className="absolute top-3 left-2 flex gap-1 items-center bg-black/50 w-fit px-1 py-0.5 rounded-xs">
        ...
        <span className="text-xs font-semibold select-none text-yellow-500 ">8.5</span>
      </div>
      ...
      <div className="opacity-0 group-hover:opacity-100 transition-all duration-600 mb-3 absolute bottom-0 w-[95%] text-white text-md left-2 right-2 flex flex-col gap-1">
        <div className="flex items-center justify-between">
          <div className="flex w-full justify-between items-center">
            <h1 className="text-md font-bold tracking-tight drop-shadow-md whitespace-nowrap truncate">Spider man</h1>
